...
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiPackage, FiShoppingCart, FiBarChart2, FiUsers, FiTrendingUp, FiMinus } from "react-icons/fi";
...
const features = [
  { icon: FiPackage, label: "Product Management", desc: "Add, edit, and organize your entire inventory with ease" },
  { icon: FiShoppingCart, label: "Order Tracking", desc: "Real-time updates from placement to delivery" },
  { icon: FiBarChart2, label: "Sales Analytics", desc: "Deep insights into revenue, trends, and performance" },
  { icon: FiUsers, label: "Customer Base", desc: "Understand and grow your audience" },
];
...
export default function LoginPage() {
  ...
  // Rotating marketing hooks for the dashboard tagline
  const continuousText = useLoopingTypewriter([
    "From inventory to analytics — everything you need to run an online store.",
    "Track orders securely, monitor your live revenue, and update stock items instantly.",
    "Empower your modern retail workflow with clean insights and daily updates."
  ], 30, 15, 2500);
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white relative overflow-hidden">
      ...
      <div className="hidden lg:flex px-16 xl:px-24 py-16 flex-col justify-between bg-gray-50/40 relative">
        ...
        >
          ...
          <span className="flex items-center gap-1"><FiTrendingUp size={12} /> Retailer Dashboard</span>
        </motion.div>
      </div>
      ...
      <div className="flex items-center justify-center p-8 relative bg-white">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1.5">Sign in to manage your digital storefront</p>
          </div>
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="pt-2">
              ...
              >
                {isPending ? (
                  ...
                  <><FiArrowRight size={16} /> Sign in to dashboard</>
                )}
              </motion.button>
            </motion.div>
          </form>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
            <div className="relative my-7">
              ...
              <div className="relative flex justify-center"><span className="px-3 text-xs text-gray-400 bg-white">New to our platform?</span></div>
            </div>
