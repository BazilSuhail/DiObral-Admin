...
import { FiArrowLeft, FiSave, FiPercent, FiDollarSign, FiHash, FiGrid, FiCalendar, FiTag, FiToggleLeft, FiX } from "react-icons/fi";
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-5">
            {!isEdit && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1.5"><FiTag size={14} className="text-gray-400" /> Coupon Code</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1.5"><FiTag size={14} className="text-gray-400" /> Discount Type</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1.5"><FiDollarSign size={14} className="text-gray-400" /> {form.type === "percentage" ? "Discount % (1-100)" : "Discount Amount ($)"}</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1.5"><FiDollarSign size={14} className="text-gray-400" /> Min Order ($)</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1.5"><FiDollarSign size={14} className="text-gray-400" /> Max Discount ($)</label>
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1.5"><FiGrid size={14} className="text-gray-400" /> Usage Limit</label>
